...
Задание состоит из пяти задач, две из которых со «звёздочкой» (соответственно они помечены символом \*). В первых трех задачах необходимо придумать или найти максимальное число решений, а также нужно объяснить
